...
<div class="row">
    <form class="row col-md-12" action="{{ route('clientes.store') }}" method="post" enctype="multipart/form-data">
    @csrf
        <!-- left column -->
        <div class="col-md-6">
                ...
                <!-- form start -->
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputProfissao" name="profissao" placeholder="Digite a profissão" value="{{ old('profissao') }}">
                        </div>
                ...
                <h3 class="card-title">Documentos</h3>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="inputRg" name="rg" placeholder="Digite o RG" value="{{ old('rg') }}">
                        </div>
