...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
                        ...
                        <table class="table table-striped" {{ $qtdAlunos ? '' : 'hidden' }}>
                            ...
                            <tbody>
                                @forelse ($turma->alunos as $aluno)
                                    ...
                                    <tr>
                                        <td>
                                            <img class="table-avatar" @if ($aluno->foto) src="{{ url('/storage/fotos/' . $aluno->id . '/' . $aluno->foto) }}" 
                        @else
            ...
            <!-- Aulas -->
            <a href="{{ route('aulas.create', ['turma_id' => $turma->id, 'data' => date('d-m-Y')]) }}" class="btn btn-primary">Nova Aula</a>
