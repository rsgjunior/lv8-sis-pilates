...
@section('content_header')
    <div class="row mb-2">
        <div class="col-md-6">
            <h1>Atualizar experimental #{{ $experimental->id }}</h1>
        </div>
        <div class="col-md-6">
            <div class="float-sm-right">
                {{ Breadcrumbs::render('experimentais.atualizarStatus', $experimental) }}
            </div>
        </div>
    </div>
@stop
        ...
        <form role="form" action="{{ route('experimentais.update', $experimental) }}" method="post">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="inputData" value="{{ $experimental->data }}" name="data" disabled>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="time" class="form-control" id="inputHorarioInicio" value="{{ date('H:i', strtotime($experimental->horario_inicio)) }}" name="horario_inicio" disabled>
                    </div>
                    <div class="col-sm-2">
                        <label for="inputHorarioFim" class="col-form-label float-right">Horário Fim</label>
                    </div>
                    <div class="col-sm-4">
                        <input type="time" class="form-control" id="inputHorarioFim" value="{{ date('H:i', strtotime($experimental->horario_fim)) }}" name="horario_fim" disabled>
                    </div>
                </div>

                <div class="form-group">
                    <label for="inputObservacao">Observação</label>
                    <textarea class="form-control" name="observacao" id="inputObservacao" cols="30" rows="5" disabled>{{ $experimental->observacao }}</textarea>
                </div>

                <p class="lead">Preenchimento posterior</p>

                <div class="form-group">
                    <label for="selectStatus" class="text-danger">Status *</label>
