            ...
            <div class="card card-default card-outline">
                <div class="card-body box-profile">
                    <div class="text-center">
                        <img class="profile-user-img img-fluid img-circle" src="{{ $aluno->foto_url }}"
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                        <li class="list-group-item">
                            <b>Cadastrado em</b> <span
                                class="float-right">{{ date('d/m/Y, H:i', strtotime($aluno->created_at)) }}</span>
                        </li>
                    </ul>
            ...
            <div class="card">
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a class="nav-link active" href="#dados_pessoais" data-toggle="tab">Dados
                                Pessoais</a></li>
                        <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">Avaliações
                                ({{ count($aluno->avaliacoes) }})</a></li>
                        <li class="nav-item"><a class="nav-link" href="#observacoes" data-toggle="tab">Observações
                                ({{ count($aluno->observacoes) }})</a></li>
                    </ul>
                </div><!-- /.card-header -->
                <div class="card-body">
                                    ...
                                    <table class="table table-striped profile-table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ date('d/m/Y', strtotime($aluno->data_nascimento)) }} -
                                                    ({{ $aluno->idade }} anos)</td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
													@if ($aluno->telefone)
														{{ $aluno->telefone }}
														<a href="https://api.whatsapp.com/send?phone=55{{ $aluno->telefone }}"
